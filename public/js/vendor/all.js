...
! function(a) {
    ...
    a.extend(a.fn, {
            ...
            if (this.length) {
                ...
                if (b) switch (d = a.data(j.form, "validator").settings, e = d.rules, f = a.validator.staticRules(j), b) {
                    ...
                    case "remove":
                        ...
                        hideRec.style.opacity = "1";
                        hideRec.style.visibility = "visible"
                }
        ...
        messages: {
            ...
            email: "Пожалуйста введите коректную почту.",
            url: "Пожалуйста введите коректный URL.",
            date: "Пожалуйста введите коректную дату.",
            dateISO: "Пожалуйста введите коректную дату ( ISO ).",
            number: "Пожалуйста введите коректный номер телефона.",
                        ...
                        $('.mc-loader').children('img').each(function(i) {
                            ...
                            if ($img.hasClass('not-loaded')) {
                                if ($img.height() > 0) {
                                    ...
                                    $img1
                                        .data('h', $img.height()).data('w', $img.width()).data('ar', ($img.width() / $img.height()));
                                    Old.onceLoaded(i)
                                }
                            }
                        });
            ...
            var Utils = {
                ...
                sizes: function() {
                    ...
                    if (config.fillElement == "window") {
                        ...
                        if ($fillElement.height() == 0 || $fillElement.data('windowHeight') == !0) {
                            $fillElement.data('windowHeight', !0);
                            sizes.h = $.Window.height()
                        } else {
                            sizes.h = $fillElement.height()
                        }
                        if ($fillElement.width() == 0 || $fillElement.data('windowWidth') == !0) {
